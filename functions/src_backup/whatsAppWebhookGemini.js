...
// Webhook principal
exports.whatsAppWebhookGemini = functions.https.onRequest(async (req, res) => {
    console.log('Webhook Gemini recebeu requisição:', req.method);
    ...
    if (req.method === 'POST') {
        try {
            ...
            console.error('Erro no webhook Gemini:', error);
            res.sendStatus(500);
        }
    }
});
